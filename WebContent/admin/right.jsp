...
<DIV class="column">
		...
		document.write(hello);
				...
				<div class="level level_no" style="">
					欢迎使用FreeCMS系统！<br/>FreeCMS商业版已发布，功能强大、开源、代码通俗易懂、注释详细、面向二次开发友好!
第一款提供移动APP的java开源CMS!致力于打造更好的中国开源CMS! 只需2600元，购买即送技术支持，让您更快熟悉，快速应用，不再困惑!
购买即送一套前台模板,大大缩短您的开发时间!详情请查看<a href="http://www.freeteam.cn" target="_blank">http://www.freeteam.cn</a>!<br/>
